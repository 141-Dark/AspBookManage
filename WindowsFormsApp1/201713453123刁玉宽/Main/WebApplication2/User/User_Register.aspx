            ...
            <form id="form1" title="form1" name="form1" class="bs-example bs-example-form " runat="server" onsubmit="checkNull(form1)" >
                 <table class="table-striped" >
                      ...
                      <tr style="margin-bottom:10px;">
                          <td><asp:TextBox title="账号" ID="TextBox1" class="form-control control-label " runat="server" Width="241px"  placeholder="输入用户名" OnTextChanged="TextBox1_TextChanged" ></asp:TextBox></td>
                      </tr>
                       ...
                       <tr>
                           <td>
                               <asp:Button ID="Button1" runat="server" class="btn  btn-primary" data-loading-text="Loading..." Text="登录" Width="241px" OnClick="Button1_Click" />
                           </td>
                       </tr>
               </table>
