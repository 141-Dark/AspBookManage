...
<body>
 ...
 <div class="div1">
      <details><summary>图书操作</summary><section>
     <ol>
        <li><a href="AddBook.aspx" target="1"><font color="#FDFCFC">添加图书</font></a> </li>
         <li><a href="BookIformation.aspx" target="1"><font color="#FDFCFC">书籍信息</font></a> </li>
     </ol>  
     </section></details>
     
     <details><summary>图书室管理</summary><section>
     <ol>
        <li><a href="BulkImport.aspx" target="1">批量导入图书</a> </li>
         <li><a href="Tribune.aspx" target="1">发布帖子</a> </li>
          <li><a href="ComAndRep.aspx" target="1">查看帖子</a> </li>
         <li><a href="ManageUser/Student.aspx" target="1">用户管理</a> </li>
