...
<body style="height: 626px">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ManageBookConnectionString3 %>" SelectCommand="SELECT * FROM [Student]"></asp:SqlDataSource>
